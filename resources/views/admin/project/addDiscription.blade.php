...
@section('content')
    ...
    <div id='projectbuild'>
        <div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="main-content-label mg-b-5">
                                    إدخال وصف المشروع بالثلاث لغات
                                </div>
                                <div class="row m-3">
                                    <div class="col-8">
            ...
            <iframe :src='link' width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy"
        ...
        content = new Vue({
            ...
            methods: {
                ...
                saveData: function(e) {
                    ...
                    this.load = true;
                    axios.post('{{ route('projects.discriptionStore') }}', formData).then(response => {
