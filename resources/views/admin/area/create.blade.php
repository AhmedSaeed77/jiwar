                    ...
                    <div class="col-md-12 col-xl-12 col-xs-12 col-sm-12">
						<div class="card">
							<div class="card-body">
                                ...
                                <div class="col-lg-4">
                                        <label class="form-label">الاسم باللغه العريه</label>
                                        <input  required="" class="form-control" name="area_ar"  placeholder="Input box" type="text">
                                </div>
                                <div class="col-lg-4">
                                        <label class="form-label">الاسم باللغه بالانجليزيه</label>
                                ...
                                <div class="col-lg-4">
                                        ...
                                        <input  required="" class="form-control" name="area_fr"  placeholder="Input box" type="text">
                                </div>
								</div>
        ...
        content = new Vue({
            ...
            methods: {
                ...
                async saveData(e) {
                    ...
                    Swal.showLoading()
                    data = await adawe('{{ route('area.store') }}' , formData)
